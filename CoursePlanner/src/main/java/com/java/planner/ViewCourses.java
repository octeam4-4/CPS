...
input[2]= input[2].substring(0,10);
...
JOptionPane.showMessageDialog(this, "Student Data Saved");
    ...
    private void initComponents() {
        ...
        if (jTable1.getColumnModel().getColumnCount() > 0) {
            ...
            jTable1.getColumnModel().getColumn(3).setHeaderValue("NumberOfHours");
            jTable1.getColumnModel().getColumn(4).setMinWidth(100);
            jTable1.getColumnModel().getColumn(4).setMaxWidth(100);
            jTable1.getColumnModel().getColumn(4).setHeaderValue("capacity");
            jTable1.getColumnModel().getColumn(5).setHeaderValue("AvailableInFall");
            jTable1.getColumnModel().getColumn(6).setHeaderValue("AvailableInSpring");
            jTable1.getColumnModel().getColumn(7).setHeaderValue("AvailableIn Summer");
            jTable1.getColumnModel().getColumn(8).setMinWidth(150);
            jTable1.getColumnModel().getColumn(8).setMaxWidth(150);
            jTable1.getColumnModel().getColumn(8).setHeaderValue("PreRequisite Courses");
            jTable1.getColumnModel().getColumn(9).setHeaderValue("Teachers");
        }

        getContentPane().add(jScrollPane1);
        jScrollPane1.setBounds(40, 170, 1201, 307);
        ...
        jButton9.setBounds(450, 510, 170, 40);
        ...
        jButton7.setBounds(1070, 510, 140, 40);
        ...
        jButton8.setBounds(860, 510, 158, 40);
        ...
        jButton10.setBounds(660, 510, 158, 40);
        ...
        jButton11.setBounds(250, 510, 170, 40);
        ...
        jButton12.setBounds(40, 510, 170, 40);

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(53, 88, 82));
        jLabel1.setText("View Courses");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(570, 80, 200, 30);
